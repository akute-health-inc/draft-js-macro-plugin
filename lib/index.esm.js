...
var addMention = function addMention(editorState, mention, mentionPrefix, mentionTrigger, entityMutability) {
  ...
  var mentionReplacedContent = Modifier.replaceText(editorState.getCurrentContent(), mentionTextSelection, "".concat(mentionPrefix).concat(mention.text), null, // no inline style needed
...
export { MentionSuggestions as MacroSuggestions, defaultSuggestionsFilter$1 as defaultSuggestionsFilter, defaultTheme };
