...
function (_Component) {
  ...
  _createClass(Entry, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(EntryComponent, {
        className: className,
...
var addMention = function addMention(editorState, mention, mentionPrefix, mentionTrigger, entityMutability) {
  ...
  var mentionReplacedContent = draftJs.Modifier.replaceText(editorState.getCurrentContent(), mentionTextSelection, "".concat(mentionPrefix).concat(mention.text), null, // no inline style needed
  ...
  var newEditorState = draftJs.EditorState.push(editorState, mentionReplacedContent, "insert-mention");
...
var defaultEntryComponent = function defaultEntryComponent(props) {
  ...
  return React__default.createElement("div", parentProps, React__default.createElement(Avatar, {
    mention: mention,
    theme: theme
...
function (_Component) {
  ...
  function MentionSuggestions(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MentionSuggestions).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_this), "onEditorStateChange", function (editorState) {
      ...
      if (!_this.props.open && !_this.props.store.isEscaped(_this.activeOffsetKey) && _this.props.suggestions.length > 0) {
        _this.openDropdown();
  ...
  _createClass(MentionSuggestions, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          popoverComponent = _this$props$popoverCo === void 0 ? React__default.createElement("div", null) : _this$props$popoverCo,
          ...
          elementProps = _objectWithoutProperties(_this$props, ["entryComponent", "popoverComponent", "onOpenChange", "onAddMention", "onSearchChange", "suggestions", "ariaProps", "callbacks", "theme", "store", "entityMutability", "positionSuggestions", "mentionTrigger", "mentionPrefix"]);

      return React__default.cloneElement(popoverComponent, _objectSpread2({}, elementProps, {
...
var defaultTheme = {
  ...
  mentionSuggestions: "mlv743z",
  // CSS classes for an entry in the suggestions component
  mentionSuggestionsEntry: "m12q5piw",
  mentionSuggestionsEntryFocused: "m14tyxfe",
  mentionSuggestionsEntryText: "m8c948t",
  mentionSuggestionsEntryAvatar: "m1p2dfmq"
};
...
var index = (function () {
  ...
  var DecoratedMentionSuggestionsComponent = function DecoratedMentionSuggestionsComponent(props) {
    return React__default.createElement(MentionSuggestionsComponent, _extends({}, props, mentionSearchProps));
  };

  var DecoratedMention = function DecoratedMention(props) {
    return React__default.createElement(Mention, _extends({}, props, {
      theme: theme,
  ...
  var DecoratedMentionSuggestionsPortal = function DecoratedMentionSuggestionsPortal(props) {
    return React__default.createElement(MentionSuggestionsPortal, _extends({}, props, {
      store: store
    }));
  };
...
exports.MacroSuggestions = MentionSuggestions;
exports.default = index;
exports.defaultSuggestionsFilter = defaultSuggestionsFilter$1;
