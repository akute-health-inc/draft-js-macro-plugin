...
var _MentionSuggestionsPortal2 = _interopRequireDefault(
  _MentionSuggestionsPortal
);
...
var _mentionSuggestionsStrategy2 = _interopRequireDefault(
  _mentionSuggestionsStrategy
);

var _mentionStyles = {
  mention: "draftJsMacroPlugin__mention__29BEd"
};

var _mentionStyles2 = _interopRequireDefault(_mentionStyles);

var _mentionSuggestionsStyles = {
  mentionSuggestions: "draftJsMacroPlugin__mentionSuggestions__2DWjA"
};

var _mentionSuggestionsStyles2 = _interopRequireDefault(
  _mentionSuggestionsStyles
);

var _mentionSuggestionsEntryStyles = {
  mentionSuggestionsEntry: "draftJsMacroPlugin__mentionSuggestionsEntry__3mSwm",
  mentionSuggestionsEntryFocused:
    "draftJsMacroPlugin__mentionSuggestionsEntryFocused__3LcTd draftJsMacroPlugin__mentionSuggestionsEntry__3mSwm",
  mentionSuggestionsEntryText:
    "draftJsMacroPlugin__mentionSuggestionsEntryText__3Jobq",
  mentionSuggestionsEntryAvatar:
    "draftJsMacroPlugin__mentionSuggestionsEntryAvatar__1xgA9"
};

var _mentionSuggestionsEntryStyles2 = _interopRequireDefault(
  _mentionSuggestionsEntryStyles
);

var _defaultSuggestionsFilter = require("./utils/defaultSuggestionsFilter");

var _defaultSuggestionsFilter2 = _interopRequireDefault(
  _defaultSuggestionsFilter
);
...
var defaultTheme = (exports.defaultTheme = {
  ...
  mentionSuggestionsEntry:
    _mentionSuggestionsEntryStyles2.default.mentionSuggestionsEntry,
  mentionSuggestionsEntryFocused:
    _mentionSuggestionsEntryStyles2.default.mentionSuggestionsEntryFocused,
  mentionSuggestionsEntryText:
    _mentionSuggestionsEntryStyles2.default.mentionSuggestionsEntryText,
  mentionSuggestionsEntryAvatar:
    _mentionSuggestionsEntryStyles2.default.mentionSuggestionsEntryAvatar
});
...
exports.default = function() {
  ...
  var _config$mentionPrefix = config.mentionPrefix,
    mentionPrefix =
      _config$mentionPrefix === undefined ? "" : _config$mentionPrefix,
    _config$theme = config.theme,
    theme = _config$theme === undefined ? defaultTheme : _config$theme,
    _config$positionSugge = config.positionSuggestions,
    positionSuggestions =
      _config$positionSugge === undefined
        ? _positionSuggestions2.default
    ...
    MentionSuggestionsComponent =
      _config$mentionSugges === undefined
        ? _MentionSuggestions2.default
        : _config$mentionSugges,
    _config$entityMutabil = config.entityMutability,
    entityMutability =
      _config$entityMutabil === undefined ? "SEGMENTED" : _config$entityMutabil,
    _config$mentionTrigge = config.mentionTrigger,
    mentionTrigger =
      _config$mentionTrigge === undefined ? "@" : _config$mentionTrigge,
    _config$mentionRegExp = config.mentionRegExp,
    mentionRegExp =
      _config$mentionRegExp === undefined
        ? _defaultRegExp2.default
        : _config$mentionRegExp,
    _config$supportWhites = config.supportWhitespace,
    supportWhitespace =
      _config$supportWhites === undefined ? false : _config$supportWhites;
  ...
  var DecoratedMention = function DecoratedMention(props) {
    return _react2.default.createElement(
      _Mention2.default,
      _extends({}, props, { theme: theme, mentionComponent: mentionComponent })
    );
  };
  var DecoratedMentionSuggestionsPortal = function DecoratedMentionSuggestionsPortal(
    ...
    return _react2.default.createElement(
      _MentionSuggestionsPortal2.default,
      _extends({}, props, { store: store })
    );
  };
  return {
    ...
    decorators: [
      ...
      {
        strategy: (0, _mentionSuggestionsStrategy2.default)(
          mentionTrigger,
          supportWhitespace,
          mentionRegExp
        ),
...
var defaultSuggestionsFilter = (exports.defaultSuggestionsFilter =
  _defaultSuggestionsFilter2.default);
